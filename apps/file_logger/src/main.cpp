...
int main(int argc, char *argv[]) {
  if (argc != 3) {
    std::cerr << "Использование: " << argv[0]
              << " <название файла> <уровень важности>\n";
  ...
  try {
    ...
    do {
      ...
      // обработка ситуации, когда пользователь ввел вместо числа что-то другое
      // (цикл, который закончится, когда пользователь введет число)
